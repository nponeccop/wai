...
defaultTlsSettings = TLSSettings {
  ...
  , tlsLogging = def
  , tlsAllowedVersions = [TLS.TLS13,TLS.TLS13ID18,TLS.TLS13ID16,TLS.TLS12,TLS.TLS11,TLS.TLS10]
  , tlsCiphers = ciphers
...
ciphers :: [TLS.Cipher]
ciphers =
    [ TLSExtra.cipher_AES128GCM_SHA256 -- TLS 1.3
    , TLSExtra.cipher_AES256GCM_SHA384 -- TLS 1.3
